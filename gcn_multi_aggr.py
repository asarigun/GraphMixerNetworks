...
#from PyG_gcn_layer_v2 import GCNConv
#from mma_layers import GCNConv
import argparse
import numpy as np
from PyG_gcn_layer_v2 import GCNConv
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        for _ in range(4):
            """
            conv = GCNConv(dropout=args.dropout, device='cuda', in_channels=75, out_channels=75,
                 aggregators=aggregators, scalers=scalers, deg=deg,
                 edge_dim=50, towers=5, post_layers = 1, divide_input= True)
            """
