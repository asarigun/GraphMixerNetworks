...
class GCNConv(MessagePassing):
    def __init__(self, in_channels: int, out_channels: int, 
                ...
                edge_dim: Optional[int] = None, towers: int = 1, post_layers: int = 1,
                divide_input: bool = True, **kwargs):
        ...
        for _ in range(towers):
            ...
            modules = [Linear(in_channels, self.F_in)]
    ...
    def message(self, x_i: Tensor, x_j: Tensor,
        ...
        hs = [nn(h[:, i]) for i, nn in enumerate(self.post_nns)]
